 ...
 *
 */
public class PingballServer2 {
    
    private final ServerSocket serverSocket;
    
    private final AtomicInteger socketID;
    
    private final ConcurrentHashMap<AtomicInteger, ServerSocket> socketMap;
     ...
     */
    public PingballServer2(int port) throws IOException {
    	this.socketID = new AtomicInteger(0);
    	this.socketMap = new ConcurrentHashMap <AtomicInteger, ServerSocket>();
         ...
         // create a new thread for each client
            Thread thread = new Thread(new Runnable() {
                public void run() {
                    // handle the client
                    try {
                    	int thisSocketID = socketID.incrementAndGet();
